...
const Visual3DCanvas = ({ mode, children }: Visual3DCanvasProps) => {
  ...
  const backgroundColor = colorBackground
    ? ColorPalette.getPalette(palette).calcBackgroundColor(0, 0)
    : false;
  ...
  return (
    ...
    >
      {colorBackground && <color attach="background" args={[backgroundColor]} />}
      <ambientLight />
